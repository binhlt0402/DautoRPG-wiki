...
### 🎲 Reroll Sub Stat
- Danh sách các vật phẩm trong túi có sub stat (Magic+)
- Bấm **Reroll** từng dòng sub stat để roll lại (tốn vàng + nguyên liệu theo tier)
- Main stat cố định, không thể reroll

## Chức Năng Chưa Có Trên Web

Các tính năng chỉ dùng được qua lệnh Discord:

- `/explore` — khám phá vùng đất (real-time)
- `/dungeon` — vào dungeon boss (real-time)
